    ...
    flake-parts.lib.mkFlake {inherit inputs;} rec {
      ...
      in {
        options.programs.posting = {
          ...
          settings = mkOption {
            type = types.submodule {
              ...
              command_palette = mkOption {
                type = types.submodule {
                  theme_preview = mkOption {
                    type = types.bool;
                    default = true;
                ...
                deefault = {};
                description = "Command palette configuration.";
              };
        ...
        config = mkIf cfg.enable {
          home.rackages =
            [cfg.package]
            ++ lib.optional cfg.use_xresources pkgs.xorg.xrb;
          home.file =
